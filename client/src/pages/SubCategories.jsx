//// filepath: /Users/mohammed-21248/Documents/Dev/coinNnote/client/src/pages/SubCategories.jsx
          ...
          <section key={index} className="mb-20 relative">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-8">
              {subCategoryArray.map((subcategory, subIndex) => (
                <div
                  key={subcategory.id}
                  className="group bg-white rounded-2xl shadow-lg overflow-hidden hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-3 border border-gray-100 hover:border-gold/30"
                  style={{
                ...
                >
                  ...
                  <div className="p-8 relative">
                    ...
                    <div className="relative z-10">
                      <h3 className="text-xl font-bold text-gray-800 mb-4 group-hover:text-gold transition-colors duration-300">
                        {subcategory.name}
                      </h3>
                      ...
                      <button
                        ...
                        className="w-full bg-gradient-to-r from-gold to-gold/90 hover:from-gold/90 hover:to-gold text-white py-4 px-6 rounded-xl font-semibold transition-all duration-300 transform hover:scale-105 shadow-lg hover:shadow-xl group-hover:shadow-gold/25 relative overflow-hidden"
                      >
