...
function Existing({ type, updateEntry }) {
  ...
  return (
    <div className="w-full mx-auto mt-0 pb-5 bg-slate-900 p-3 h-[90vh] rounded-2xl flex flex-col justify-between">
          ...
          <div className="bg-white px-8 py-10 rounded shadow-lg z-10 relative">
            ...
            <button
              ...
              onClick={() => {
                ...
                getAllCurrenciesAndNotes(setData, setTotalPage, 1);
                setShowDelete(null);
                showToast(toast, "success", "Product Deleted successfully");
              }}
            >
              Delete
            </button>
